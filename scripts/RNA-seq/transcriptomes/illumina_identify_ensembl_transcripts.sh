...
# Script Name:        illumina_identify_ensembl_transcripts.sh
# Author:             Aidan Tay

# Description: Pipeline for identifying known (Ensembl) transcripts
...
getTranscripts() {
    ...
    ## Clean up
    rm ${TRANSCRIPTOMES_OUTPUT_DIR}/${outputFilePrefix}_*temp*
}
